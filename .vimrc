...
nnoremap <silent> <leader>gu :!pr_integrate update_only<cr>
nnoremap <silent> <leader>gU :!pr_integrate<cr>
...
nnoremap <silent> <leader>gL :tabnew<cr>:Flog -all -auto-update<cr>
